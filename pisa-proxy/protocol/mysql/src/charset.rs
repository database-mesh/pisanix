...
pub const DEFAULT_CHARSET_NAME: &str = "utf8mb4_general_ci";
pub const DEFAULT_COLLATION_NAME: &str = "utf8mb4_general_ci";

// Data from `select ID,CHARACTER_SET_NAME from COLLATIONS;`.
//charset key is charset name and value is default collation id
lazy_static! {
    pub static ref COLLATION_NAME_ID_MYSQL5: HashMap<&'static str, u8> = HashMap::from([
        ("big5_chinese_ci", 1),
        ("latin2_czech_cs", 2),
        ("dec8_swedish_ci", 3),
        ("cp850_general_ci", 4),
...
lazy_static! {
    pub static ref COLLATION_ID_NAME_MYSQL5: HashMap<u8, &'static str> = HashMap::from([
        (1, "big5_chinese_ci"),
        (2, "latin2_czech_cs"),
        (3, "dec8_swedish_ci"),
        (4, "cp850_general_ci"),
...
lazy_static! {
    pub static ref COLLATION_ID_NAME_MYSQL8: HashMap<u8, &'static str> = HashMap::from([
        (1, "big5_chinese_ci"),
        (2, "latin2_czech_cs"),
        (3, "dec8_swedish_ci"),
        (4, "cp850_general_ci"),
...
lazy_static! {
    pub static ref COLLATION_NAME_ID_MYSQL8: HashMap<&'static str, u8> = HashMap::from([
        ("big5_chinese_ci", 1),
        ("latin2_czech_cs", 2),
        ("dec8_swedish_ci", 3),
        ("cp850_general_ci", 4),
