...
use crate::{util::BufExt, mysql_const::ColumnType};
...
mod test {
    use bytes::BytesMut;
    use crate::{mysql_const::ColumnType, client::column::ColumnBuf};

    #[test]
    fn test_parse_column_info() {
        let data = [
            0x03, 0x64, 0x65, 0x66, 0x00, 0x00, 0x00, 0x01, 0x3f, 0x00, 0x0c,
            0x3f, 0x00, 0x00, 0x00, 0x00, 0x00, 0xfd, 0x80, 0x00, 0x00, 0x00, 0x00,
        ];
